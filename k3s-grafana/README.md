...
* And an example of how a [dashboard] can be imported from a configmap -- The goal is not to have persistent data.  Destroying and recreating the VM with the scripts will bring back all of the config without the need of backups.
